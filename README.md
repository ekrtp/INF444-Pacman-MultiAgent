...
python pacman.py -p ExpectimaxAgent -l capsuleClassic -q -n 3
python pacman.py -p ExpectimaxAgent -l mediumClassic -q
python pacman.py -p ExpectimaxAgent -l powerClassic -q
```
